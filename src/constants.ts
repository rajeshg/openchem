...
// Average atomic masses (Da) - weighted average of all isotopes
// Used for molecular weight calculations (RDKit-compatible)
// Source: IUPAC/CIAAW standard atomic weights 2021
export const AVERAGE_ATOMIC_MASSES: Record<string, number> = {
  H: 1.008,
  He: 4.0026,
  Li: 6.94,
  Be: 9.0122,
...
// Used for exact mass calculations (most abundant isotope)
